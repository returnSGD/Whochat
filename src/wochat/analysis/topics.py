...
from wochat.pipeline.rules import stopwords, tokenize
...
def aggregate_by_content(repo, version: str, keyword: str | None = None) -> tuple[list[str], list[str]]:
    ...
    from wochat.store.models import AnalysisResult, Comment, RawContent
    from wochat.store.repository import _comment_analysis
